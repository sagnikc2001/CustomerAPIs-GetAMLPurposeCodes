...
@MockEndpointsAndSkip("http://localhost:8084/api/connector/db/bancsdb/v1/BancsAMLPurposeCodeStoreProcedure.*|http://localhost:8082/api/connector/configstore.*")
...
public class GetAMLPurposeCodesTest {
	...
	@EndpointInject("mock://http:localhost:8084/api/connector/db/bancsdb/v1/BancsAMLPurposeCodeStoreProcedure")
